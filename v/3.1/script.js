...
elements.hypobromite = {
		color: "#FFAE42",
		behavior: behaviors.SOLIDPOWDER,
		category: "rocks",
		burn: 10,
		burnTime: 200,
		fireColor: "#A05729",
...
elements.infinitium = {
		...
		state: "solid",
		density: 10**100,
		description: "Infinitium, an extraordinary element with an infinite mass and density, defies the conventional boundaries of matter. Its chemical properties showcase a remarkable ability to bend the fabric of space-time, generating gravitational fields so immense that they warp surrounding environments. Theoretical uses of Infinitium span from revolutionary energy generation through controlled gravitational fusion to enabling a gateway into hitherto uncharted realms of physics, offering the potential to unravel mysteries that have long eluded scientific exploration.",
};
/*
...
elements.whiteHole = {
		...
		hardness: 1,
		category: 'astronomical',
		description: "White holes, fascinating cosmic phenomena predicted by theoretical physics, are enigmatic counterparts to black holes. In this speculative realm, they exhibit opposite properties, expelling matter and energy outward instead of consuming them. While not yet observed, their theoretical existence could hold the key to understanding the nature of time, offering the potential for traversable wormholes and opening doors to unprecedented cosmic exploration. Just as Infinitium challenges the boundaries of matter, white holes challenge our understanding of the fundamental fabric of the universe, inviting us to explore the uncharted territories of theoretical physics.",
};
elements.blue_giant = {
		color: "#add8e6",
		behavior: [
		...
		reactions: {
			"time": {	"elem1": "supernova" },
			"reverse": {	"elem1": "dust" },
		},
		hardness: 50,
		temp: 29726,
		category: 'astronomical',
		description: "Blue giant stars, colossal luminous celestial objects, represent some of the most massive and hottest stars in the universe. With temperatures that can exceed 30,000 degrees Celsius, these giants emit intense blue-white light, captivating the observer with their brilliance. Despite their relatively short lifespans compared to smaller stars, blue giants play a vital role in the universe, synthesizing heavy elements and dispersing them upon their eventual explosive demise as supernovae, contributing to the intricate cosmic tapestry of elements and energy.",
};
elements.bluelight = {
								color: "#bdd8e6",
								name: "BlueGiantLight",
								...
								state: "gas",
								density: 0.00001,
								description: "Blue light is a high-energy, short-wavelength electromagnetic radiation within the visible spectrum. It possesses more energy than longer-wavelength light, such as red or green. Blue light is known for its role in influencing various biological processes, including circadian rhythms and sleep patterns, and is prevalent in natural sunlight.The light emitted by blue giant stars is primarily in the blue and ultraviolet regions of the electromagnetic spectrum due to their extremely high temperatures. These stars are among the hottest in the universe, with surface temperatures exceeding 30,000 degrees Celsius. Their immense heat causes them to emit a substantial amount of blue and ultraviolet light, contributing to their striking blue-white appearance. This intense emission makes blue giant stars highly luminous and visible from great distances, showcasing their significance in cosmic exploration and understanding stellar evolution.",
						},
elements.red_dwarf = {
		color: "#ff5349",
		behavior: [
		...
		reactions: {
			"time": {	"elem1": "orange_dwarf" },
			"reverse": {	"elem1": "dust" },
		},
		hardness: 25,
		temp: 3627,
		category: 'astronomical',
		description: 'Red dwarves are small, cool stars that emit a warm, reddish glow. They belong to the main sequence of stars and are the most common type in the universe. Due to their relatively low temperatures, red dwarves emit most of their light in the red and infrared parts of the electromagnetic spectrum. Despite their modest size, red dwarves have incredibly long lifespans, potentially burning for trillions of years. Their distinct color and longevity make them fascinating subjects for studying stellar processes and the potential for habitable exoplanets orbiting around them.',
};
elements.orange_dwarf = {
		color: "#ffa04b",
		behavior: [
										"XX|XX|XX",
										"CR:redlight|XX|CR:redlight",
		...
		reactions: {
			"time": {	"elem1": "purple_dwarf" },
			"reverse": {	"elem1": "red_dwarf" },
		},
		hardness: 25,
		temp: 3627,
		category: 'astronomical',
...
elements.purple_dwarf = {
		color: "#a64aff",
		behavior: [
										"XX|XX|XX",
										"CR:bpurpl|XX|CR:redlight",
										"XX|CR:infraredlight|XX",
								],
		reactions: {
			"time": {	"elem1": "blue_dwarf" },
			"reverse": {	"elem1": "orange_dwarf" },
		},
		hardness: 25,
		temp: 3627,
		category: 'astronomical',
		description: 'Purple dwarves, a transitional phase between orange and blue dwarves in the stellar life cycle, emit a captivating hue reminiscent of twilight. These stars mark a fleeting yet enchanting stage. As red dwarves exhaust their nuclear fuel, they transform into these purple entities before transitioning into the luminous brilliance of blue dwarves, each color encapsulating a distinct epoch in the celestial chronicle.',
};
elements.blue_dwarf = {
		color: "#add8e6",
		behavior: [
										"XX|XX|XX",
										"CR:bpurpl|XX|CR:bpurpl",
										"XX|CR:infraredlight|XX",
								],
		reactions: {
			"time": {	"elem1": "white_dwarf" },
			"reverse": {	"elem1": "purple_dwarf" },
		},
		hardness: 25,
		temp: 3627,
		category: 'astronomical',
		description: 'Blue dwarves, the vibrant offspring of purple dwarves in the stellar evolution narrative, dazzle the cosmos with their hex color code #4B6AFF. These stars signify a dynamic phase of transformation, where the remnants of a red dwarfs core ignite anew, emitting a scintillating azure radiance. As they burn with youthful energy, blue dwarves eventually mature into the luminous white dwarves, leaving an indelible mark on the canvas of the universe.',
};
elements.white_dwarf = {
		...
		reactions: {
			"time": {	"elem1": "black_dwarf" },
		},
		hardness: 48,
		temp: 7726,
		breakInto: ["helium", "oxygen", "carbon", "neon"],
		category: 'astronomical',
		description: "White dwarves are the remnants of once-massive stars that have exhausted their nuclear fuel. These incredibly dense stellar remnants are small, yet incredibly hot, emitting a brilliant white light. Their immense density is the result of gravitational collapse, with the mass of a star compressed into a volume roughly the size of Earth. As they cool over billions of years, white dwarves transition from emitting white light to reddish hues, eventually fading into darkness. Their study provides insights into the late stages of stellar evolution and the fate of our own Sun.",
};
//ax2+bx+c=0
///confirm("Currently Eshaan is doing development on LabSim. Check back later, or go back to 2.7.2, the latest stable release!\nIf you use this right now you might have the sandbox randomly not load or elements randomly disappearing.\n\nWHAT'S BEING WORKED ON\n* Stars\n* Time\n* Reverse time\n* Category clutter management\n* Removal of unnecessary items");
elements.black_dwarf = {
		reactions: {
			"time": {	"elem1": "void" },
			"reverse": {	"elem1": "white_dwarf" },
		},
		color: "#000000",
		behavior: behaviors.STURDYPOWDER,
		hardness: 45,
		...
		temp: -273,
		category: 'astronomical',
		description: 'Black dwarves represent the serene and enigmatic end state of a white dwarf stars evolution. Born from the remnants of once-vibrant stars, these celestial objects have cooled to the point where they no longer emit visible light. The name "black dwarf" is somewhat misleading, as they dont actually appear black in the traditional sense, but rather they radiate faint heat in the form of infrared radiation. These ancient, cold remnants silently drift through the vastness of space, serving as a reminder of the universes inexorable march toward entropy and the eventual fade-out of even the brightest stars.',
};
elements.redlight = {
								color: "#df5349",
								name: "RedStarlight",
...
elements.bpurpl = {
								...
								density: 0.00001,
										...
										"white_dwarf": {	"elem1": "black_dwarf" },
								}
										// Red Dwarf Life Cycle
										"red_dwarf": {	"elem1": "orange_dwarf" },
										"orange_dwarf": {	"elem1": "purple_dwarf" },
										"purple_dwarf": {	"elem1": "blue_dwarf" },
										"blue_dwarf": {	"elem1": "white_dwarf" },*/
elements.whiteLight = {
								color: "#ffffff",
								name: "WhiteStarLight",
								behavior: [
...
elements.lonsdaleite = {
		colorOn: ["#64defa", '#00ffc0'],
		behavior: behaviors.SOLIDPOWDER,
		category: "solids",
		conduct: 0.5,
		hardness: 1.1,
		state: "solid",
		color: ["#03ecfc","#03fcc6","#b3ffba","#8ae6b0"],
		tempHigh: 5432.1,
		stateHigh: 'molten_graphite',
		ignore: ["armageddon"],
		density: 5000,
		atoms: ["iridium", "carbon", "carbon", "carbon", "carbon", "carbon"],
		breakInto: "lonsdaleite_powder",
};
elements.raw_lonsdaleite = {
		colorOn: ["#64defa", '#00ffc0'],
		behavior: behaviors.STURDYPOWDER,
		category: "astronomical",
		conduct: 0.5,
		hardness: 1.1,
		state: "solid",
		color: ["#03ecfc","#03fcc6","#b3ffba","#8ae6b0", "#0103a7"],
		tempHigh: 5432.1,
		stateHigh: 'molten_graphite',
		ignore: ["armageddon"],
		density: 5000,
...
elements.lonsdaleite_pollution = {
		colorOn: ["#64defa", '#00ffc0'],
...
elements.chyme = {
	...
	behavior: behaviors.POWDER,
	reactions: {
		"small_intestine": { "elem1":"poop" },
		"gallbladder": {"elem1":"pee"},
	},
		category: "dirty",
		viscosity: 1,
		state: "solid",
		description: "Chyme is a semi-fluid mixture of partially digested food and gastric juices that is produced in the stomach during digestion. It is the result of mechanical and chemical breakdown of food in the stomach, and it moves into the small intestine for further digestion and absorption of nutrients.",
		density: 43,
};
elements.small_intestine = {
		color: "#DE260C",
	behavior: [
		"XX|XX|XX",
		"XX|XX|XX",
...
elements.red_pee = {
	...
	behavior: [
		...
		category: "dirty",
		name: "Severely Dehydrated Urine",
		viscosity: 1.46,
		tempHigh: 100,
...
elements.brown_pee = {
	...
	behavior: [
		...
		category: "dirty",
		name: "Extremely Dehydrated Urine",
		viscosity: 2.37,
		tempHigh: 100,
...
elements.gallbladder = {
		color: "#70543e",
	behavior: [
		"CR:gallstone%0.00075|CR:urea%0.001|CR:blood%0.00025",
		"XX|XX|XX",
		"DL:bile%0.005|CR:bile%0.23|CR:bile%0.00005",
	],
		category: "dirty",
		viscosity: 2.37,
		tempHigh: 100,
		stateHigh: ["fart","blood", "dirt", "bile", "urea"],
		tempLow: 0,
		stateLow: ["pee_ice","blood", "frozen_dirt"],
		reactions: {},
		breakInto: ["bile", "bile", "bile", "bile", "bile", "blood", "blood"],
...
elements.komatiite = {
		...
		burnInto: "polished_komatite",
};
elements.polished_komatiite = {
		color: "#AEB5AE",
		behavior: behaviors.SOLIDPOWDER,
		category: "rocks",
		tempHigh: 1600,
...
elements.lithium = {
	...
	reactions: {
		...
		"fluorine": {"elem1": "lithium_fluoride", chance: 0.9},
	},
	category: 'solids',
	behavior: behaviors.SOLID,
	tempHigh: 180.5,
...
elements.flourine = {
	...
	state: 'gas',
	reactions: {
		"lithium": {"elem1": "lithium_fluoride", chance: 0.9},
		"sodium": {"elem1": "sodium_fluoride", chance: 0.9},
		"potassium": {"elem1": "potassium_fluoride", chance: 0.9},
		"rubidium": {"elem1": "rubidium_fluoride", chance: 0.9},
	},
	behavior: behaviors.VAPOUR,
	category: 'vapours',
	tempLow: -188,
...
I shall also attibute Ryan/slweeb/R74n from Sandboxels (https://sandboxels.r74n.com) for making this site possible. He made the original web site that we forked!
*/
runAfterLoad(function() {
	foodArray = Object.keys(elements).filter(function(e) {
		return elements[e].category == "edible";
	});
